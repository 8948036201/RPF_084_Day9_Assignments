...
public class EmployeeWageUC8Employee {
	...
	public EmployeeWageUC8Employee(String companyName, String empName, int workingHour, int wagePerHour, int maxWorkingDay,
			int maxWorkingHour) {
